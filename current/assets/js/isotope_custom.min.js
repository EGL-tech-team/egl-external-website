...
/* __________________ Toggle Mobile Navigation to show primary navigation on small screens __________________*/
	$('.mobile-filter-trigger').click(function () {
		$('.filter-clone').slideToggle('fast');
		$(this).toggleClass('active');
	});
	
	
	$('.sort').clone().removeClass('sort').addClass('sort-mobile').appendTo('.filter-clone');

	var $container = $('.three_col, .two_col, .four_col');

	$('.sort-mobile li a').click(function () {
		$('.sort-mobile li a').removeClass('active');
		$(this).addClass('active');
		var selector = $(this).attr('data-filter');
		$container.isotope({
			filter: selector
		});		
		$('.filter-clone').slideUp();
		return false;
	});